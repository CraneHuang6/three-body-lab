...
1. 下载 `zip` 文件
2. 双击解压，得到 `ThreeBodyLab.app`
3. 打开 Finder 中的“应用程序”文件夹
4. 把解压出来的 `ThreeBodyLab.app` 拖进“应用程序”
5. 以后请尽量从“应用程序”里打开 `ThreeBodyLab`，不要直接在下载目录里运行
...
1. “系统设置”
2. “隐私与安全性”
3. 下滑到页面底部，找到关于 `ThreeBodyLab` 的安全提示
4. 点击“仍要打开”
5. 回到“应用程序”，再次打开 `ThreeBodyLab`
